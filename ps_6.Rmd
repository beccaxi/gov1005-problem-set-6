...
# create the function: I first create a full deck, (bootstrap) sample 1000 times
# with replacement from this deck, group by each sample, and find the mean of
# each sample. I then pull just the distribution of the bootstrapped sample
# means and, as above, use the percentile method to calculate the desired
